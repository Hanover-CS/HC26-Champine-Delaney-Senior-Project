...
- Kotlin: for Android app functionality
    ...
    - Java is another language that would work well towards Android app functionality. However, Java is incompatable with Jetpack Compose, which is the UI and design software I am using.
